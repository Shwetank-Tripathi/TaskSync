    ...
    return (
        <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/20 rounded-lg p-4 shadow-lg hover:border-purple-500/30 transition-all duration-200">
            ...
            <div className="mb-4">
                ...
                <p className="text-xs text-slate-400">Enter a room ID to join existing workspace</p>
            </div>
            ...
            <div className="space-y-3">
                <div>
                    ...
                    <input
                        ...
                        disabled={loading}
                        className={`w-full px-3 py-2 bg-slate-700/50 border rounded-md text-white text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${
                            error 
                    ...
                    {/* Error Message */}
                    {error && (
                        <div className="mt-1.5 flex items-start text-red-400">
                    ...
                    {!error && (
                        <p className="text-xs text-slate-400 mt-1">
                            Room ID format: 24 hexadecimal characters (0-9, a-f)
                        </p>
                    )}
                </div>
                ...
                <button 
                    ...
                    className="w-full py-2.5 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 disabled:from-slate-600 disabled:to-slate-600 text-white text-sm font-medium rounded-md transition-all duration-200 shadow-lg hover:shadow-green-500/25 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center"
                >
                    {loading ? (
                        <>
